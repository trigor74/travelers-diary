...
public class App extends android.app.Application {
    ...
    public void onCreate() {
        ...
        Query activeTravelQuery = new Firebase(Utils.getFirebaseUserActiveTravelUrl(userUID));
        activeTravelQuery.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query reminderQuery = new Firebase(Utils.getFirebaseUserReminderUrl(userUID));
        reminderQuery.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                Utils.disableAlarmGeofence(getApplicationContext(), reminderItem);
